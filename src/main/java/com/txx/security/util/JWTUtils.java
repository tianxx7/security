package com.txx.security.util;


import com.txx.security.common.ResponseCode;
...
public class JWTUtils {
	...
	public static synchronized JWTUtils getInstance(String modulus, String privateExponent, String publicExponent) {
	 ...
	 public static synchronized void reload(String modulus, String privateExponent, String publicExponent) {
		priKey = RSAUtils.getPrivateKey(modulus, privateExponent);
		pubKey = RSAUtils.getPublicKey(modulus, publicExponent);
	}
	...
	public static class JWTResult {
		...
		private JWTResult(boolean status, String uid, String msg, int code) {
			super();
			this.status = status;
			this.uid = uid;
			this.msg = msg;
